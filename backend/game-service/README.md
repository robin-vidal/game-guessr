...
```
POST /api/v1/rooms/DEMO01/start   { "hostId": "my-user-id" }
GET  /api/v1/rooms/DEMO01/round
POST /api/v1/rooms/DEMO01/guess   { "playerId": "my-user-id", "phase": "GAME", "textAnswer": "Mario Kart 8" }
GET  /api/v1/rooms/DEMO01/results
```
...
|---|---|---|
| `POST` | `/api/v1/rooms/{code}/start` | Start a match (generates 5 rounds) |
| `GET` | `/api/v1/rooms/{code}/round` | Get current round info (no coordinates) |
| `POST` | `/api/v1/rooms/{code}/guess` | Submit a guess → publishes Kafka event |
| `GET` | `/api/v1/rooms/{code}/results` | Final results with true coordinates |
